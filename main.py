...
2. MINIMAL TEXT & PEDAGOGY (TOKEN LIMIT PREVENTION):
   ...
   - To prevent API token limit crashes, restrict the deck to a MAXIMUM of 8 slides, and generate a MAXIMUM of 3 heavy `web_widget` scripts per deck.
3. INTERACTIVE MEDIA & GRAPHING (UBIQUITOUS WIDGETS):
   ...
   - MANDATORY HUD TELEMETRY: Every canvas MUST render an overlay HUD via `ctx.fillText`:
     * Title (x=20, y=30): 16px monospace, #00E5FF.
     * Step Tracker (x=20, y=55): 14px monospace, #fbbf24 (e.g., "Step 1/4: Init").
     * Telemetry (x=20, y=80): 14px monospace, #10b981 (live math values).
     * Footer Guide (x=20, y=580): 12px monospace, #64748b ("Click Left: Prev Step | Click Right: Next Step | [Interaction: Drag/Orbit]").
   ...
   - STYLING DIRECTIVE (CINEMATIC PALETTE): 
     * Background: #0f172a
     * Axes/Grids: #334155 / #64748b
     * Primary Elements: #00E5FF
     * Secondary Elements: #10b981
     * Active Highlights: #fbbf24
     * Errors/Alerts: #f43f5e
4. COMPACTNESS:
